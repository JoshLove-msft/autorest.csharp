...
namespace AutoRest.CSharp.Common.Output.Expressions.KnownValueExpressions
{
    ...
    {
        public MethodBodyStatement WriteLine() => new InvokeInstanceMethodStatement(Untyped, nameof(StringBuilder.AppendLine));
        // public MethodBodyStatement WriteChildObject() => new InvokeInstanceMethodStatement(Untyped, nameof(StringBuilder.AppendChild));
