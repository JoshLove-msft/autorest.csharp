...
namespace MgmtDiscriminator.Models
{
    public partial class OriginGroupOverride : IUtf8JsonSerializable, IJsonModel<OriginGroupOverride>, IPersistableModel<OriginGroupOverride>
    {
        ...
        void IJsonModel<OriginGroupOverride>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OriginGroupOverride)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            sb.AppendChildObject(OriginGroup, options);
            sb.AppendLine($"ForwardingProtocol: '{ForwardingProtocol}'");
        ...
        BinaryData IPersistableModel<OriginGroupOverride>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OriginGroupOverride)} does not support '{options.Format}' format.");
            }
        }
