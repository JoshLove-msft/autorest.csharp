...
namespace MgmtDiscriminator.Models
{
    public partial class DeliveryRuleCacheExpirationAction : IUtf8JsonSerializable, IJsonModel<DeliveryRuleCacheExpirationAction>, IPersistableModel<DeliveryRuleCacheExpirationAction>
    {
        ...
        void IJsonModel<DeliveryRuleCacheExpirationAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DeliveryRuleCacheExpirationAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DeliveryRuleCacheExpirationAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DeliveryRuleCacheExpirationAction)} does not support '{options.Format}' format.");
            }
        }
