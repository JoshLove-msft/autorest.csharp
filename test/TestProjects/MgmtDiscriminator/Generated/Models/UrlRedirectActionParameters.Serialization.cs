...
namespace MgmtDiscriminator.Models
{
    public partial class UrlRedirectActionParameters : IUtf8JsonSerializable, IJsonModel<UrlRedirectActionParameters>, IPersistableModel<UrlRedirectActionParameters>
    {
        ...
        void IJsonModel<UrlRedirectActionParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UrlRedirectActionParameters)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            sb.AppendLine($"RedirectType: '{RedirectType}'");
            sb.AppendLine($"DestinationProtocol: '{DestinationProtocol}'");
            sb.AppendChildObject(CustomPath, options);
            sb.AppendChildObject(CustomHostname, options);
            sb.AppendChildObject(CustomQueryString, options);
            sb.AppendChildObject(CustomFragment, options);
        ...
        BinaryData IPersistableModel<UrlRedirectActionParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UrlRedirectActionParameters)} does not support '{options.Format}' format.");
            }
        }
