...
{
    public partial class DeliveryRuleRouteConfigurationOverrideAction : IUtf8JsonSerializable, IJsonModel<DeliveryRuleRouteConfigurationOverrideAction>, IPersistableModel<DeliveryRuleRouteConfigurationOverrideAction>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleRouteConfigurationOverrideAction>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DeliveryRuleRouteConfigurationOverrideAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DeliveryRuleRouteConfigurationOverrideAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DeliveryRuleRouteConfigurationOverrideAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DeliveryRuleRouteConfigurationOverrideAction)} does not support '{options.Format}' format.");
            }
        }
