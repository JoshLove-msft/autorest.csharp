...
namespace MgmtDiscriminator.Models
{
    public partial class RemoteAddressMatchConditionParameters : IUtf8JsonSerializable, IJsonModel<RemoteAddressMatchConditionParameters>, IPersistableModel<RemoteAddressMatchConditionParameters>
    {
        ...
        void IJsonModel<RemoteAddressMatchConditionParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RemoteAddressMatchConditionParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RemoteAddressMatchConditionParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RemoteAddressMatchConditionParameters)} does not support '{options.Format}' format.");
            }
        }
