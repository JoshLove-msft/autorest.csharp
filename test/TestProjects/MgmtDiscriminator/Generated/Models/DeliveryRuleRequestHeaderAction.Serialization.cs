...
{
    public partial class DeliveryRuleRequestHeaderAction : IUtf8JsonSerializable, IJsonModel<DeliveryRuleRequestHeaderAction>, IPersistableModel<DeliveryRuleRequestHeaderAction>
    {
        ...
        void IJsonModel<DeliveryRuleRequestHeaderAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DeliveryRuleRequestHeaderAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DeliveryRuleRequestHeaderAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DeliveryRuleRequestHeaderAction)} does not support '{options.Format}' format.");
            }
        }
