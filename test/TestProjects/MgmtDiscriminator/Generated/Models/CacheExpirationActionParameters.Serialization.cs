...
namespace MgmtDiscriminator.Models
{
    public partial class CacheExpirationActionParameters : IUtf8JsonSerializable, IJsonModel<CacheExpirationActionParameters>, IPersistableModel<CacheExpirationActionParameters>
    {
        ...
        void IJsonModel<CacheExpirationActionParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CacheExpirationActionParameters)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            sb.AppendLine($"CacheBehavior: '{CacheBehavior}'");
            sb.AppendLine($"CacheType: '{CacheType}'");
            sb.AppendLine($"CacheDuration: '{CacheDuration}'");
        ...
        BinaryData IPersistableModel<CacheExpirationActionParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CacheExpirationActionParameters)} does not support '{options.Format}' format.");
            }
        }
