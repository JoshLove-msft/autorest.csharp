...
{
    public partial class UrlRewriteAction : IUtf8JsonSerializable, IJsonModel<UrlRewriteAction>, IPersistableModel<UrlRewriteAction>
    {
        ...
        void IJsonModel<UrlRewriteAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UrlRewriteAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UrlRewriteAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UrlRewriteAction)} does not support '{options.Format}' format.");
            }
        }
